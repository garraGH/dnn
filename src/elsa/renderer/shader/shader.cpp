...
#define ENUM_TO_STRING(x)                        \
    ...
    ENUM_TO_STRING(INSTANCE);                    
    ENUM_TO_STRING(DIFFUSE_REFLECTANCE);
    ENUM_TO_STRING(SPECULAR_REFLECTANCE);
    ENUM_TO_STRING(EMISSIVE_COLOR);
    ENUM_TO_STRING(DIFFUSE_MAP);
    ENUM_TO_STRING(SPECULAR_MAP);
    ENUM_TO_STRING(EMISSIVE_MAP);
    ENUM_TO_STRING(NORMAL_MAP);
    ENUM_TO_STRING(HEIGHT_MAP);
    ENUM_TO_STRING(DISPLACEMENT_MAP);
    ENUM_TO_STRING(PARALLAX_MAP);
